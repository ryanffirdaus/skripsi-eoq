                    ...
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
                            ...
                            <ChartCard title="Distribusi Level Inventori" description="Kategori stok saat ini">
                                <PieChart
                                    data={dashboardData.inventoryLevelDistribution || []}
                                    nameKey="name"
                                    valueKey="value"
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
                            ...
                            <ChartCard title="Distribusi Status Penugasan" description="Status penugasan saat ini">
                                <PieChart data={dashboardData.assignmentStatusDistribution || []} nameKey="name" valueKey="value" height={250} />
                            </ChartCard>
                        </div>
                    </div>
                </div>
