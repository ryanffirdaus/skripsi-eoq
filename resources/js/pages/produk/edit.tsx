                    ...
                    <div className="space-y-2 rounded-md border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-900">
                        ...
                        <div className="space-y-2">
                            {data.bahan_baku.map((item, index) => (
                                <div
                                    key={index}
                                    className="grid grid-cols-1 items-center gap-2 rounded-md bg-white p-3 shadow-sm sm:grid-cols-3 dark:bg-gray-800"
                                >
                                    ...
                                    <button
                                        ...
                                        className={`${buttonVariants.destructive} w-fit rounded p-1.5 sm:justify-self-end`}
                                    >
    ...
    return (
        ...
        >
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <FormField id="stok_produk" label="Stok" error={errors.stok_produk} required>
                    <NumberInput
                        id="stok_produk"
